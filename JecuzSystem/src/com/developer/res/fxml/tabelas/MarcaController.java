...
public class MarcaController implements Initializable {
    ...
    private void atualizarGrade(Integer pagina) {
        ...
        String queryComands = "SELECT p FROM Produttype p ";

        Query querys = Util.enti.createQuery(queryComands).setHint(QueryHints.REFRESH, true);
        List<Produttype> lista = querys.getResultList();
    ...
    public final class ItemLista {
        ...
        private MarcaController myInstance;
        private Produttype entity;

        public ItemLista(int id, int index, String desigancao, HBox myBox,
                JFXButton btnEliminar, JFXButton btnEditar,
                MarcaController myInstance, Produttype entity) {
            this.id = id;
            this.index = index;
        ...
        public MarcaController getMyInstance() {
            return myInstance;
        }

        public Produttype getEntity() {
            return entity;
        }
    ...
    private ObservableList<ItemLista> listar(int quantidade, int pagina) {
        ...
        String queryComandss = "SELECT p FROM Produttype p";

        Query querys = Util.enti.createQuery(queryComandss, Produttype.class).setHint(QueryHints.REFRESH, true)
