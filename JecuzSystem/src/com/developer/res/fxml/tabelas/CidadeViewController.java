 ...
 * @author hdglo
 */
public class CidadeViewController implements Initializable {
    ...
    @FXML
    private TableColumn  tc_cidade;
    @FXML
    private TableColumn  tc_pais;
    @FXML
    ...
    private void openModal(ActionEvent event) {
     ...
     public void caregarLista() {
        ...
        tc_cidade.setCellValueFactory(
                new PropertyValueFactory("desigancao")
        );
        tc_pais.setCellValueFactory(
    ...
    public final class ItemLista {
        ...
        private CidadeViewController myInstance;
        private City entity;

        public ItemLista(int id, int index, String desigancao, String pais, HBox myBox,
                JFXButton btnEliminar, JFXButton btnEditar,
                CidadeViewController myInstance, City entity) {
            this.id = id;
            this.index = index;
        ...
        public CidadeViewController getMyInstance() {
            return myInstance;
        }
    ...
    private ObservableList<ItemLista> listar(int quantidade, int pagina) {
        ...
        String queryComandss = "SELECT p FROM City p";

        Query querys = Util.enti.createQuery(queryComandss, City.class).setHint(QueryHints.REFRESH, true)
