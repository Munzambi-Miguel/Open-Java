...
public class UnidadesController implements Initializable {
    ...
    private void atualizarGrade(Integer pagina) {
        ...
        String queryComands = "SELECT p FROM Unidade p ";

        Query querys = Util.enti.createQuery(queryComands).setHint(QueryHints.REFRESH, true);
        List<Unidade> lista = querys.getResultList();
    ...
    public final class ItemLista {
        ...
        private UnidadesController myInstance;
        private Unidade entity;

        public ItemLista(int id, int index, String desigancao, String sigla, HBox myBox,
                JFXButton btnEliminar, JFXButton btnEditar,
                UnidadesController myInstance, Unidade entity) {
            this.id = id;
            this.index = index;
        ...
        public UnidadesController getMyInstance() {
            return myInstance;
        }
    ...
    private ObservableList<ItemLista> listar(int quantidade, int pagina) {
        ...
        String queryComandss = "SELECT p FROM Unidade p";

        Query querys = Util.enti.createQuery(queryComandss, Unidade.class).setHint(QueryHints.REFRESH, true)
